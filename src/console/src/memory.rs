...
pub fn init_stable_state() -> StableState {
    StableState {
        ...
        proposal_assets: StableBTreeMap::init(get_memory_assets()),
        proposal_content_chunks: StableBTreeMap::init(get_memory_content_chunks()),
        proposals: StableBTreeMap::init(get_memory_batch_group_proposals()),
    }
}
