pub mod state {
    ...
    use crate::storage::types::state::{ProposalAssetsStable, ProposalContentChunksStable};
    ...
    pub struct StableState {
        ...
        pub proposal_assets: ProposalAssetsStable,
        pub proposal_content_chunks: ProposalContentChunksStable,
    }
