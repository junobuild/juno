<script lang="ts">
	...
	import NotificationsAlerts from '$lib/components/app/notifications/NotificationsAlerts.svelte';
	import NotificationsAlertsLoader from '$lib/components/app/notifications/NotificationsAlertsLoader.svelte';
	import NotificationsInbox from '$lib/components/app/notifications/NotificationsInbox.svelte';
	import NotificationsInboxLoader from '$lib/components/app/notifications/NotificationsInboxLoader.svelte';
