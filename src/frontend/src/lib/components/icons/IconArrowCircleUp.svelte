<!-- source: https://fonts.google.com/icons?selected=Material+Symbols+Rounded:arrow_circle_up:FILL@0;wght@300;GRAD@0;opsz@24&icon.size=24&icon.color=%23e8eaed&icon.query=arrow_circle_up&icon.set=Material+Symbols&icon.style=Rounded -->
<script lang="ts">
	interface Props {
		size?: string;
	}
