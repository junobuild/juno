<!-- source: https://fonts.google.com/icons?selected=Material+Symbols+Outlined:block:FILL@0;wght@300;GRAD@0;opsz@24&icon.size=24&icon.color=%23000000&icon.query=block&icon.set=Material+Symbols -->
<script lang="ts">
	interface Props {
		size?: string;
	}
