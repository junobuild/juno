<!-- source: https://fonts.google.com/icons?selected=Material+Symbols+Rounded:import_contacts:FILL@0;wght@400;GRAD@0;opsz@24&icon.size=24&icon.color=%23000000&icon.query=book -->
<svg
	fill="currentColor"
	height="24px"
