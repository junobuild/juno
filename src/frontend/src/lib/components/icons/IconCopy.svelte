<!-- source: https://fonts.google.com/icons?selected=Material+Symbols+Outlined:content_copy:FILL@0;wght@100;GRAD@0;opsz@24&icon.size=24&icon.color=%23000000&icon.query=copy&icon.set=Material+Symbols -->
<script lang="ts">
	interface Props {
		size?: string;
	}
