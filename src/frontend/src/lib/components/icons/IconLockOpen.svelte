<!-- source: https://fonts.google.com/icons?icon.size=24&icon.color=%23000000&icon.query=lock&selected=Material+Symbols+Outlined:lock_open:FILL@0;wght@300;GRAD@0;opsz@24 -->
