<!-- https://fonts.google.com/icons?selected=Material+Symbols+Rounded:passkey:FILL@0;wght@400;GRAD@0;opsz@24&icon.size=24&icon.color=%23e8eaed&icon.query=passke&icon.style=Rounded -->
<script lang="ts">
	interface Props {
		size?: string;
		withTitle?: boolean;
