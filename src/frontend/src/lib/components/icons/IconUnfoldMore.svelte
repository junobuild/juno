<!-- source: https://fonts.google.com/icons?selected=Material+Symbols+Rounded:unfold_more:FILL@0;wght@300;GRAD@0;opsz@24&icon.size=24&icon.color=%23e8eaed&icon.query=unfol&icon.style=Rounded -->
<script lang="ts">
	interface Props {
		size?: string;
	}
