<script lang="ts">
	...
	import CanisterMonitoringChart from '$lib/components/modules/canister/monitoring/CanisterMonitoringChart.svelte';
	import CanisterMonitoringData from '$lib/components/modules/canister/monitoring/CanisterMonitoringData.svelte';
