<script lang="ts">
	...
	import CanisterStart from '$lib/components/modules/canister/lifecycle/CanisterStart.svelte';
	import CanisterStop from '$lib/components/modules/canister/lifecycle/CanisterStop.svelte';
