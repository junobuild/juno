<script lang="ts">
	...
	import Area from '$lib/components/modules/charts/Area.svelte';
	import AxisX from '$lib/components/modules/charts/AxisX.svelte';
	import AxisY from '$lib/components/modules/charts/AxisY.svelte';
	import Line from '$lib/components/modules/charts/Line.svelte';
