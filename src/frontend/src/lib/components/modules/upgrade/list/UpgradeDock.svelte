<script lang="ts">
	import UpgradeDockLoader from '$lib/components/modules/upgrade/list/UpgradeDockLoader.svelte';
	import UpgradeMissionControl from '$lib/components/modules/upgrade/list/UpgradeMissionControl.svelte';
	import UpgradeOrbiter from '$lib/components/modules/upgrade/list/UpgradeOrbiter.svelte';
	import UpgradeSatellite from '$lib/components/modules/upgrade/list/UpgradeSatellite.svelte';
