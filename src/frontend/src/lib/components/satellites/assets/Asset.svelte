<script lang="ts">
	...
	import AssetToken from '$lib/components/satellites/assets/AssetToken.svelte';
	import AssetUpload from '$lib/components/satellites/assets/AssetUpload.svelte';
	import DataHeader from '$lib/components/satellites/data/DataHeader.svelte';
	import DataKeyDelete from '$lib/components/satellites/data/DataKeyDelete.svelte';
