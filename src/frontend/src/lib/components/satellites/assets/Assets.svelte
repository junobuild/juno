<script lang="ts">
	...
	import AssetUpload from '$lib/components/satellites/assets/AssetUpload.svelte';
	import CollectionEmpty from '$lib/components/satellites/collections/CollectionEmpty.svelte';
	import DataCollectionDelete from '$lib/components/satellites/data/DataCollectionDelete.svelte';
	import DataCollectionHeader from '$lib/components/satellites/data/DataCollectionHeader.svelte';
