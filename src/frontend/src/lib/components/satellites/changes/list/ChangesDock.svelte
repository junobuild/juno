<script lang="ts">
	...
	import Change from '$lib/components/satellites/changes/list/Change.svelte';
	import ChangesDockLoader from '$lib/components/satellites/changes/list/ChangesDockLoader.svelte';
	import ChangesFilter from '$lib/components/satellites/changes/list/ChangesFilter.svelte';
	import ChangesMore from '$lib/components/satellites/changes/list/ChangesMore.svelte';
