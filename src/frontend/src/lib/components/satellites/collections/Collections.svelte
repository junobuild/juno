<script lang="ts">
	...
	import CollectionEdit from '$lib/components/satellites/collections/CollectionEdit.svelte';
	import CollectionSelection from '$lib/components/satellites/collections/CollectionSelection.svelte';
	import CollectionsNav from '$lib/components/satellites/collections/CollectionsNav.svelte';
