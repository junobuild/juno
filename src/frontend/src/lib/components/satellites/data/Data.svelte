<script lang="ts">
	...
	import CollectionsEmpty from '$lib/components/satellites/collections/CollectionsEmpty.svelte';
	import DataNav from '$lib/components/satellites/data/DataNav.svelte';
