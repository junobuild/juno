<script lang="ts">
	...
	import Data from '$lib/components/satellites/data/Data.svelte';
	import DataCollectionsHeaderWithoutFilter from '$lib/components/satellites/data/DataCollectionsHeaderWithoutFilter.svelte';
	import DataCount from '$lib/components/satellites/data/DataCount.svelte';
	import Doc from '$lib/components/satellites/docs/Doc.svelte';
	import DocForm from '$lib/components/satellites/docs/DocHeader.svelte';
	import Docs from '$lib/components/satellites/docs/Docs.svelte';
