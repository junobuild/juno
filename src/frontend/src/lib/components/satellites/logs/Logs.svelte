<script lang="ts">
	...
	import Log from '$lib/components/satellites/logs/Log.svelte';
	import LogsFilter from '$lib/components/satellites/logs/LogsFilter.svelte';
	import LogsOrder from '$lib/components/satellites/logs/LogsOrder.svelte';
	import LogsRefresh from '$lib/components/satellites/logs/LogsRefresh.svelte';
