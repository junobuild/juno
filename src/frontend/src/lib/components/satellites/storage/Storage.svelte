<script lang="ts">
	...
	import StorageCollections from '$lib/components/satellites/storage/StorageCollections.svelte';
	import StorageData from '$lib/components/satellites/storage/StorageData.svelte';
