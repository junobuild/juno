<script lang="ts">
	...
	import Asset from '$lib/components/satellites/assets/Asset.svelte';
	import Assets from '$lib/components/satellites/assets/Assets.svelte';
	import Data from '$lib/components/satellites/data/Data.svelte';
	import DataCollectionsHeaderWithFilter from '$lib/components/satellites/data/DataCollectionsHeaderWithFilter.svelte';
