...
import type { DocRepositoryKey, RunId, Workflow, WorkflowKey } from '$lib/types/workflow';
...
export const toDocRepositoryKey = ({ owner, name }: SatelliteDid.RepositoryKey): DocRepositoryKey =>
	`${owner}/${name}`;
