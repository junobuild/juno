...
pub const JUNO_COLLECTIONS_ERROR_RESERVED_COLLECTION: &str = "juno.collections.error.reserved_collection";
// Rate config cannot be disabled.
pub const JUNO_COLLECTIONS_ERROR_RATE_CONFIG_ENABLED: &str = "juno.collections.error.rate_config_enabled";
// Collection starting with {} cannot be deleted
pub const JUNO_COLLECTIONS_ERROR_DELETE_PREFIX_RESERVED: &str = "juno.collections.error.prefix_deletion";
