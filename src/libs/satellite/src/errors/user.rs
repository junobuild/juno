...
pub const JUNO_DATASTORE_ERROR_USER_WEBAUTHN_CANNOT_UPDATE: &str =
    "juno.datastore.error.user.cannot_update_webauthn";
pub const JUNO_DATASTORE_ERROR_USER_INVALID_WEBAUTHN_DATA: &str =
    "juno.datastore.error.user.invalid_webauthn_data";
// Caller and public key must match. Only the user can create their webauthn entry.
pub const JUNO_DATASTORE_ERROR_USER_CALLER_WEBAUTHN_KEY: &str =
    "juno.datastore.error.user.caller_webauthn_key";
