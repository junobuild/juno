pub mod state {
    use crate::db::types::state::{DbCollectionsIds, DbCollectionsStable, DbHeapState, DbStable};
    ...
    pub struct StableState {
        ...
        pub db_collections_ids: DbCollectionsIds,
        pub db_collections: DbCollectionsStable,
