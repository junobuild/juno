use crate::state::store::set_on_upload_asset_collections;
...
#[rquickjs::function]
fn on_upload_asset_loader<'js>(_ctx: Ctx<'js>, collections: Vec<String>) -> JsResult<()> {
    set_on_upload_asset_collections(&collections);
