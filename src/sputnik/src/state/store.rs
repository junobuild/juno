...
pub fn set_upload_asset_collections(collections: &[CollectionKey]) {
    mutate_state(|state| state.runtime.hooks.upload_asset_collections = collections.to_owned());
}

pub fn get_upload_asset_collections() -> Vec<CollectionKey> {
    read_state(|state| state.runtime.hooks.upload_asset_collections.clone())
}

pub fn set_delete_asset_collections(collections: &[CollectionKey]) {
    mutate_state(|state| state.runtime.hooks.delete_asset_collections = collections.to_owned());
}

pub fn get_delete_asset_collections() -> Vec<CollectionKey> {
    read_state(|state| state.runtime.hooks.delete_asset_collections.clone())
}

pub fn set_delete_many_assets_collections(collections: &[CollectionKey]) {
    mutate_state(|state| state.runtime.hooks.delete_many_assets_collections = collections.to_owned());
}

pub fn get_delete_many_assets_collections() -> Vec<CollectionKey> {
    read_state(|state| state.runtime.hooks.delete_many_assets_collections.clone())
}

pub fn set_on_delete_filtered_assets_collections(collections: &[CollectionKey]) {
    mutate_state(|state| state.runtime.hooks.on_delete_filtered_assets_collections = collections.to_owned());
}

pub fn get_on_delete_filtered_assets_collections() -> Vec<CollectionKey> {
    read_state(|state| state.runtime.hooks.on_delete_filtered_assets_collections.clone())
}
...
pub fn set_assert_upload_asset_collections(collections: &[CollectionKey]) {
    mutate_state(|state| state.runtime.hooks.assert_upload_asset_collections = collections.to_owned());
}
...
pub fn set_assert_delete_asset_collections(collections: &[CollectionKey]) {
    mutate_state(|state| state.runtime.hooks.assert_delete_asset_collections = collections.to_owned());
}
