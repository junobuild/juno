...
export const idlFactory = ({ IDL }) => {
	...
	const AppDemoAntonioResultSub = IDL.Record({
	...
	const AppMyHttpTransformArgs = IDL.Record({
	...
	return IDL.Service({
		...
		app_my_http_transform: IDL.Func([AppMyHttpTransformArgs], [AppHttpRequestResult], ['query']),
