...
export const ERROR_USER_CANNOT_UPDATE = 'juno.satellite.error.user.cannot_update';
export const ERROR_USER_INVALID_DATA = 'juno.satellite.error.user.invalid_data';
export const ERROR_USER_CALLER_KEY = 'juno.satellite.error.user.caller_key';
export const ERROR_USER_KEY_NO_PRINCIPAL = 'juno.satellite.error.user.key_no_principal';
export const ERROR_USER_NOT_ALLOWED = 'juno.satellite.error.user.not_allowed';
