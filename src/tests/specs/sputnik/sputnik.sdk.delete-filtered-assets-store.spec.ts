...
describe('Sputnik > sdk > deleteFilteredDocsStore', () => {
	...
	const TEST_COLLECTION = 'test-deletefilteredassets';
	const MOCK_COLLECTION = 'demo-deletefilteredassets';
	...
	it('should count documents', async () => {
		...
		expect(assets.items_length).toEqual(BigInt(keys.length) - expectedDeletedCount);
	});
});
